                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">{{__('category.label_novo')}}</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">×</span>
                                            </button>
                                        </div>
                                        <form id="formCategory" action="{{route('category.store')}}"  class="needs-validation mb-5 was-validated" novalidate method="POST"  enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">

                                             
                                                <div class="form-group">
                                                    <label for="name">{{__('category.label_name')}} <small style="font-size:10px;color:red">*</small></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="logo">{{__('category.label_logo')}} <small style="font-size:10px;color:red">* Formato solo svg.</small></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2-multiple" multiple="multiple" name="species_id[]" id="species_id"   required>
                                                        <option value="">{{__('category.label_species')}}</option>
                                                ...
                                                <div class="form-group">
                                                    <label for="status">{{__('category.label_type')}}  <small style="font-size:10px;color:red">*</small></label>
                                                    <select class="form-control" name="type" id="type" required>
                                                   
                                                        <option value="0">{{__('general.product')}}</option>
                                                        <option value="1">{{__('general.service')}}</option> 
                                                        <option value="2">{{__('general.veterinary')}}</option> 
                                                    </select>
                                                </div>


                                                <div class="form-group">
                                                    <label for="status">{{__('category.label_status')}}  <small style="font-size:10px;color:red">*</small></label>
