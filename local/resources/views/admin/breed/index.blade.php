...
@section('title') {{__('breed.title')}} @endsection
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">    
                            ...
                            <div class="jumbotron">
                                ...
                                <hr class="my-4">
                               @include('admin.breed.partials.table')
                               @include('admin.breed.partials.modal_form')
                            </div>
        ...
        $.ajax({
                ...
                success:function(data){
                    ...
                    if(data.status==false){
                        alert('success', "{{__('breed.notification.message')}}", "{{__('breed.notification.save')}}");
                    }
                    else{
                        alert('error', "{{__('breed.notification.message')}}","{{__('breed.notification.error')}}")
                    }
                     ...
                     if(datos.isConfirmed){
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                ...
                                $("#species_id").val(data.data.species_id)
...
function activar(idvalor){
    ...
    $.ajax({
                            type:'GET',
                            url:"{{url('admin/breed/status/')}}/"+idvalor,

                            contentType: false,
                            processData: false,
                            success:function(data){
                                alert('success', "{{__('breed.notification.message')}}", data.mensaje);
