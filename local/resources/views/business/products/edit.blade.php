            ...
            <input name="id" type="hidden" value="{{$info->id}}">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-8 col-sm-12">
                                ...
                                <input type="text" maxlength="100" value="{{$info->name}}" name="name" id="name" class="form-control" required placeholder="{{__('products.name')}}">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 col-sm-12">
                                ...
                                <select class="form-control" name="categories_id" id="categories_id" required>
                                    ...
                                    <option value="{{$infocategory->id}}" @if($info->category_id == $infocategory->id) selected @endif>{{ $infocategory->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4 col-sm-12">  
                                ...
                                <option value="">Seleccione</option> 
                                    ...
                                    <option value="{{$infobrand->id}}" @if($info->marca_id==$infobrand->id) selected @endif>{{ $infobrand->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-2 col-sm-12">
                                ...
                                <input type="number" name="cantidad" id="cantidad" class="form-control" value="{{$info->cantidad}}" required >
                            </div>

                            <div class="form-group col-md-3 col-sm-12">
                                <label>{{__('services.price')}} <b> {{__('services.label_money')}}</b> <small style="font-size:10px;color:red">*</small></label>
                                <input type="text" name="price" id="price" value="{{$info->price}}" class="form-control" required placeholder="{{__('services.price')}}">
                            </div>
                            ...
                            <div class="form-group col-md-3 col-sm-12">  
                                ...
                                <option value="">Seleccione</option>
                                <option value="1" @if(@$info->details['porte']==1) selected @endif>Pequeno</option> 
                                <option value="2" @if(@$info->details['porte']==2) selected @endif>M&eacute;dio</option>
                                <option value="3" @if(@$info->details['porte']==3) selected @endif>Grande</option> 
                                <option value="4" @if(@$info->details['porte']==4) selected @endif>Mini</option> 
                                <option value="5" @if(@$info->details['porte']==5) selected @endif>Gigante</option> 
                                </select>
                        ...
                        <input type="checkbox" @if($info->offerts == 1) checked @endif class="custom-control-input" id="offerts_products" name="offerts_products">
                        <label class="custom-control-label" for="offerts_products">Coloque o produto em oferta</label></div>
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                ...
                                <input type="text" @if($info->offerts == 0) readonly @endif  name="price_offerts" value="{{$info->amount_offerts}}" id="price_offerts" class="form-control" required placeholder="{{__('services.price')}}">
                            </div>
                        ...
                        <div class="form-group  col-md-12 col-sm-12">
                                ...
                                <div id="quill-description">{!!$info->description!!}</div>
                                <input type="hidden" name="description" id="description" value="{{$info->description}}"  >
                            </div>
                        ...
                        <div class="form-group col-md-3 col-sm-12">
                                ...
                                <input class="form-control" value="{{@$info->details['altura']}}"  name="altura" id="altura" placeholder="{{__('products.label_altura')}}">
                            </div>

                            <div class="form-group col-md-3 col-sm-12">
                                <label>{{__('products.label_largo')}} </label>
                                <input class="form-control" value="{{@$info->details['largo']}}" name="largo" id="largo" placeholder="{{__('products.label_largo')}}">
                            </div>


                            <div class="form-group col-md-3 col-sm-12">
                                <label>{{__('products.label_ancho')}} </label>
                                <input class="form-control"  name="ancho" value="{{@$info->details['ancho']}}" id="ancho" placeholder="{{__('products.label_ancho')}}">
                            </div>
                            <div class="form-group col-md-3 col-sm-12">
                                <label>{{__('products.label_peso')}} </label>
                                <input class="form-control"  name="peso" value="{{@$info->details['peso']}}" id="peso" placeholder="{{__('products.label_peso')}}">
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                            <div class="col-6">
                                <img src="{{$info->photo}}" alt="Imagen" style="width:200px;heigth:200px">
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        @foreach($info->details['photo'] as $imgs)
                        <div class="col-3">
                        <img src="{{asset($info->urlphoto($imgs))}}" style="width:200px;heigth:200px" alt="Imagen">
                        <button class="btn btn-warning" > Apagar Imagen</button>
                        </div>
                        @endforeach
                        </div><br><br>
                    </div>
...
var quillToolbarOptionsContents = [
    ...
    let species=[{{$info->speciesArrays($info->details['species'])}}];
    $("#subcategories_id").change(function() {
        var valor = $("#subcategories_id").val();
        if(valor > 0){
        selectoptionsAnimals(valor, species);}
    });

   
   let subaca={{$info->details['subcategory']}};
    var valor = $("#categories_id").val();
    selectoptions(valor, subaca);
    selectoptionsAnimals(subaca, species)
