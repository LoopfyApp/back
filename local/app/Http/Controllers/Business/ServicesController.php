...
class ServicesController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $datos = UserServices::where('users_id',Auth()->user()->id)->where('type_option',0)->get();
        ...
        $datos=array('title'=>trans('menu.service'),'subtitles'=>trans('services.title') );
        return view('business.servicios.index')->with(['datos'=>$datos]);
    }

    
    public function add(Request $request)
    {
        $catgorias=Category::where('type',1)->get();
        $datos=array('title'=>trans('menu.service'),'subtitles'=>trans('services.add') );
        return view('business.servicios.add')->with(['datos'=>$datos,'category'=>$catgorias]);
    }
    ...
    public function edit($id)
    {
        ...
        $catgorias=Category::where('type',1)->get();
        $datos=array('title'=>trans('menu.service'),'subtitles'=>trans('services.add') );
        return view('business.servicios.edit')->with(['datos'=>$datos,'category'=>$catgorias,'datosinfo'=>$datosinfo]);
    }
    ...
    public function storeData(Request $request){
      ...
      if($request->id==0){
        ...
        return redirect()->route('business.services.index')->with('message','Datos Registrado Correctamente');
